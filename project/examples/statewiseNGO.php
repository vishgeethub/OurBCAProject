...
$rs=$con->query("select * from ngo_table n,state s,area a,city c where a.areaid=n.areaid and a.cityid=c.cityid and s.stateid=c.stateid and c.stateid='".$_POST["sid"]."'");
$html="Date:".date("d-m-Y");
$html = $html.<<<EOD
<br>
<h3><b>Statewise NGO Report</b></h3>
<br>
<table border="1">
<tr>
	...
	<td style="border:1px solid black;padding:5px">Regestration Date</td>
</tr>
EOD;
