...
$rs=$con->query("select * from event_table e,category_table ca,area a, city c,state s  where ca.cat_id = e.cat_id and a.areaid=e.areaid and a.cityid=c.cityid and s.stateid=c.stateid and e.cat_id='".$_POST["catid"]."'");

$html="Date:".date("d-m-Y");
$html = $html.<<<EOD
<br>
<br>
<h3><b>Categorywise Event Report</b></h3>
<br>
<table border="1" >
<tr>
