...
$rs=$con->query("select * from event_table e,category_table ca,area a, city c,state s  where ca.cat_id = e.cat_id and a.areaid=e.areaid and a.cityid=c.cityid and s.stateid=c.stateid  and e.eventdate>='$date1' and e.eventdate<='$date2' ");

$html="Date:".date("d-m-Y");
$html = $html.<<<EOD
<br>
<h3><b>Datewise Event Report</b></h3>
<br>
<table border="1">
<tr>
