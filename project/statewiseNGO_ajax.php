<?php
	...
	$rsb=$obj->query("select * from ngo_table n,state s,area a,city c where a.areaid=n.areaid and a.cityid=c.cityid and s.stateid=c.stateid and c.stateid='$sid' order by n.rdate");
?>
<style>
.table{
		color:dark grey;
...
<center>
<span class="table">Details of NGO</span><br>
<br>
...
<table class="tbl" border=2>
	...
	<?php	
		...
		?>
			...
			<br>
			<form action="tcpdf/examples/statewiseNGO.php" method="post">
