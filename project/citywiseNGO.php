...
function data()
{
	...
	xcity.onreadystatechange = function()
		...
		xcity.open("GET","citywiseNGO_ajax.php?x="+cid,true);
		xcity.send();
        }
function city()
{
...
<center>
<span class="header">Citywise NGO</span>
...
<tr>
	...
	<tr>
		<td>&nbsp;</td>
		<td style="padding:5px"><div id="d5"><input type="button" class="tbox" onclick="data();" value="Submit" name="b1" style="width:150px;font-size=18px;"></div></td>
</tr>
